...
v51_uyuni_tools_sles15sp7_repos: Dict[str, Set[str]] = {
    "server": {
...
v51_uyuni_tools_slmicro61_repos: Dict[str, Set[str]] = {
    "server": {
...
v51_nodes_static_client_tools_repositories: Dict[str, Set[str]] = {
    "alma8_minion": {
...
def get_v51_static_and_client_tools(variant: str = "slmicro61") -> (Dict[str, Dict[str, str]], Dict[str, List[str]]):
    ...
    uyuni_dicts = {
        "slmicro61": v51_uyuni_tools_slmicro61_repos,
        "sles15sp7": v51_uyuni_tools_sles15sp7_repos,
    }
