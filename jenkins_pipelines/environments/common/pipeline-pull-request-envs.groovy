...
update_repo = "http://minima-mirror.mgr.prv.suse.net/jordi/some-updates/"
additional_repo = "http://minima-mirror.mgr.prv.suse.net/jordi/dummy/"
...
if (env.JOB_NAME == "uyuni-prs-ci-tests-jordi") {
    ...
    update_repo = "http://minima-mirror.mgr.prv.suse.net/jordi/some-updates43/"
    additional_repo = "http://minima-mirror.mgr.prv.suse.net/jordi/dummy43/"
    rn_package = "release-notes-susemanager"
    rn_project = "Devel:Galaxy:Manager:4.3:ToSLE"
    // Set must_build = false to skip the build phase for debugging purposes
    must_build = false
